...
#run with interaction so tha HSD output is useful
...
Litter.anova.plot <- ggplot(Litter, aes(y = dryMass, x = nlcdClass, color = functionalGroup)) +
  ...
  labs(x= "NLCD Class", y = "Dry Mass (g)", colr = "Functional group")+
  stat_summary(aes(x=nlcdClass, y = dryMass, group = functionalGroup), position = position_dodge(0.75), 
